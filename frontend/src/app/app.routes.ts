...
import { CameraScanComponent } from "./pages/camera-scan/camera-scan.component";
import { ReceiptsListComponent } from "./pages/receipts-list/receipts-list.component";
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: "Receipts | Receipt Scan AI",
      },
      {
        path: "receipts/:id",
        component: ReceiptDetailComponent,
        title: "Receipt Detail | Receipt Scan AI",
      },

      {
        path: "scan-receipt",
        component: ScanReceiptComponent,
        title: "Extract Receipt | Receipt Scan AI",
      },

      { path: "camera-scan", 
        component: CameraScanComponent,
        title: "Scan Receipt | Receipt Scan AI",
      },
      {
        path: "line-chart",
