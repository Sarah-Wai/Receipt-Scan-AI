...
class LLMRouterConfig:
    ...
    text_model: str = GROQ_TEXT_MODEL
...
def route_and_extract_receipt(
    *,
    ...
    if route == "ocr_text":
        ...
        return call_text_llm(ocr_text=ocr_text, config=cfg)
...
def call_vision_llm(
    *,
    ...
    try:
        image_data_url = _encode_image_data_url(img_path)

        raw_text = _groq_chat_vision(
            api_key=cfg.api_key,
